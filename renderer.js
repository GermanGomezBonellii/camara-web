...
export const categories={Básicos:['Ninguno','Saturación','Blanco y negro','Negativo','Blur','Pixelado'],Color:['Rojo profundo','Cianotipo','Terminal verde','CRT ámbar','Ultravioleta','Duotono','Acid'],Visión:['Infrarrojo','Mapa térmico','Visión nocturna','X-Ray'],Gráficos:['Solarizado','Poster rojo','Chrome','Pop rojo']};
...
else if(effect==3)outColor=mix(c,1.-c,t);
